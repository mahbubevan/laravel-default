                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div id="wizard_verticle" class="form_wizard wizard_verticle">
                      ...
                      <form class="form-horizontal form-label-left" method="POST" action="{{route('admin.ticket.category.update',$category->id)}}" enctype="multipart/form-data">
                          @csrf
                      <div id="step-11">
                        <h2 class="StepTitle">Step 1 Content</h2>
                          ...
                          <div class="form-group row w-50">
                            ...
                            <input type="text" class="col-md-8" name="title" value="{{$category->title}}">
                        </div>
                        ...
                        <div class="form-group row">
                            <img src="{{asset('assets/uploads/ticket/'.$category->img)}}" class="img-fluid img-thumbnail" width="100px" height="100px" alt="">
                        </div>
                         <div class="form-group row m-5">
                             <label for="" class="col-md-12 font-weight-bold">Details About This Category</label>
                                ...
                                name="details" id=""
                                cols="300" rows="10">{{$category->details}}</textarea>
                            </div>
                      </div>
                      <div id="step-22">
                            ...
                            <div class="form-group row w-75">
                                ...
                                <input type="text" class="col-md-4" name="price" value="{{$category->price}}">
                            </div>
                            <div class="form-group row w-75">
                                <label for="" class="col-md-3">Set Limit</label>
                                <input type="text" class="col-md-4" name="limit" value="{{$category->limit}}">
                            </div>
                      </div>
                      <div id="step-33">
                            ...
                            @foreach (json_decode($category->features, true) as $key=>$feature)
                                <div id="get_key" style="display:none;">{{sizeof(json_decode($category->features,true))}}</div>
                            <div id="item{{$key}}" class="form-group row w-75">
                                    <label for="" class="col-md-3">Item </label>
                                <input type="text" class="col-md-4" name="features[]" value="{{$feature}}">
                                <span class="ml-3"><button type="button" name="remove" id="{{$key}}" class="btn btn-sm btn-danger btn_remove">X</button></span>
                            </div>
                            @endforeach
                            <div id="custom"></div>
