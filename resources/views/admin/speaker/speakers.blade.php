          ...
          <div class="">
            <div class="page-title">
              ...
              <div class="col-md-12 col-sm-12 shadow-lg p-3 mb-5 bg-white rounded">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Available<small>Speakers</small></h2>
                        ...
                        <tbody>
                            @foreach ($speakers as $speaker)
                                <tr>
                                    ...
                                    <td>
                                                <span>
                                    <a href="{{route('admin.speaker.show',$speaker->id)}}" class="btn btn-sm btn-info">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                </span>
                                <span>
                                    <a href="{{route('admin.speaker.edit',$speaker->id)}}" class="btn btn-sm btn-success">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                </span>
                                <span>
                                    <a href="{{route('admin.speaker.delete',$speaker->id)}}" onclick="return confirm('Are you sure?')" class="btn btn-sm btn-danger">
