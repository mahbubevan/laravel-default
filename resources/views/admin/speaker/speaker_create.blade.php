                  ...
                  <div class="x_content">
                   ...
                   <div id="message"></div>
                    ...
                    <div id="wizard" class="form_wizard wizard_horizontal">
                      <ul class="wizard_steps">
                        ...
                        <li>
                          <a href="#step-3">
                            ...
                            <span class="step_descr">
                                              Step 3<br />
                                              <small>Step 3 Designation</small>
                                          </span>
                          </a>
                        </li>
                        <li>
                      ...
                      <form class="form-horizontal form-label-left" action="{{route('admin.speaker.store')}}" method="POST" enctype="multipart/form-data">
                          @csrf
                      <div id="step-1">
                      ...
                      <div id="step-2">
                        <h2 class="StepTitle">Step 2 Bio</h2>
                             <div class="form-group row">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="bio">Bio<span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 ">
                      ...
                      <div id="step-4">
                       ...
                       <div class="form-group row">
                        ...
                        <div class="form-group row mt-5 pull-right">
                            <button type="submit" class="btn btn-md btn-outline-success">Add New Speaker</button>
                        </div>
                      </div>
                      </form>
                    </div>
